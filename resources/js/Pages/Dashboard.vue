                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-4">
                    <form @submit.prevent="submit">
                        ...
                        <div class="my-7">
                            ...
                            <span>Valor: {{ fechaCompraSeleccionada }}</span>
                        </div>
                        ...
                        <div class="my-7">
                            ...
                            <span>Selected: {{ productoSeleccionado }}</span>
                            <button type="button" @click="agregarProductoAOrden">Agregar producto a orden</button>
                        </div>
